  ...
  return (
    <section className="w-full min-h-dvh bg-[#252525] flex flex-col ">
      <nav className="bg-white">
        <section className="flex justify-between items-center bg-white w-full text-black md:px-7 px-3 py-5 max-w-screen-2xl mx-auto">
          <div className=" ">
            <Image src='/blender_logo.png' alt="blender logo" width={120} height={10} className=" object-contain" />
          </div>

          <div className="">
            <ul className=" gap-3 md:gap-5 text-zinc-600 items-center hidden sm:flex font-medium text-sm md:text-base">

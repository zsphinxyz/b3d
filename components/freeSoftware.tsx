...
export default function FreeSoftware() {
  return (
    <section className="min-h-[640px] h-dvh max-h-[1000px] relative cursor-default w-full flex flex-col justify-center gap-10 mx-auto">
      ...
      <Image src='/blender_community_badge_orange.png' width={75} height={75} alt="Blender Community Badge" className="absolute -top-1 left-3" />
    </section>
  )
}
